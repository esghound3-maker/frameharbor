...
Version: FFmpeg 9.0 Essentials Build for Windows

Build provider: https://www.gyan.dev/ffmpeg/builds/

Release mirror: https://github.com/GyanD/codexffmpeg/releases/tag/9.0

Upstream project: https://ffmpeg.org/
Upstream source: https://github.com/FFmpeg/FFmpeg/tree/n9.0

The bundled build reports that it was configured with GPL and GPLv3 components. Its license text is included at:
